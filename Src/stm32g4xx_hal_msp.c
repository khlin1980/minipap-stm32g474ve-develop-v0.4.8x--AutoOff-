...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = MT_TEMPERATURE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(MT_TEMPERATURE_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(MT_TEMPERATURE_GPIO_Port, MT_TEMPERATURE_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C3_MspInit 0 */
    ...
    PC9     ------> I2C3_SDA
    */
    GPIO_InitStruct.Pin = I2C3_SCL_UCPD_Pin|I2C3_SDA_UCPD_Pin;
  ...
  /* USER CODE END I2C4_MspInit 0 */
    ...
    PC7     ------> I2C4_SDA
    */
    GPIO_InitStruct.Pin = I2C4_SCL_SENSOR_Pin|I2C4_SDA_SENSOR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PC9     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(I2C3_SCL_UCPD_GPIO_Port, I2C3_SCL_UCPD_Pin);

    HAL_GPIO_DeInit(I2C3_SDA_UCPD_GPIO_Port, I2C3_SDA_UCPD_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PC7     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(I2C4_SCL_SENSOR_GPIO_Port, I2C4_SCL_SENSOR_Pin);

    HAL_GPIO_DeInit(I2C4_SDA_SENSOR_GPIO_Port, I2C4_SDA_SENSOR_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PD7     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = LED_BLE_R_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(LED_BLE_R_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LED_BLE_G_Pin|LED_BLE_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = LED_PWR_R_Pin|LED_PWR_G_Pin|LED_PWR_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PE1     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = UART1_TX_BLE_Pin|UART1_RX_BLE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = UART2_TX_MT_Pin|UART2_RX_MT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PE1     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOE, UART1_TX_BLE_Pin|UART1_RX_BLE_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, UART2_TX_MT_Pin|UART2_RX_MT_Pin);
