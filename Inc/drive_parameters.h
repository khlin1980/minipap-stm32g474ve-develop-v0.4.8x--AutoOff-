...
/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD              1 /*!<Maximum accepted
                                                            variance on speed
...
#define PID_TORQUE_KP_DEFAULT         1183
#define PID_TORQUE_KI_DEFAULT         592
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           1183
#define PID_FLUX_KI_DEFAULT           592
...
#define PID_SPEED_KP_DEFAULT          2500/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          2999/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          20 /*!< Over-voltage
                                                         threshold */
...
#define ON_OVER_VOLTAGE                 TURN_OFF_PWM /*!< TURN_OFF_PWM,
                                                         ...
                                                         TURN_ON_LOW_SIDES */
#endif /* 0 */
#define R_BRAKE_SWITCH_OFF_THRES_V      16
...
#define PHASE3_FINAL_CURRENT           3630
/* Phase 4 */
#define PHASE4_DURATION                2000 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (4500*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           4356
/* Phase 5 */
#define PHASE5_DURATION                1000 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (6200*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           3630
...
#define ADC_SAMPLING_CYCLES (2 + SAMPLING_CYCLE_CORRECTION)
